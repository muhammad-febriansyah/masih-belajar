...
export default function Index({
        ...
        return (
            <motion.figure
                ...
                className={cn(
                    ...
                    "border-gray-200/50 bg-white/80 hover:bg-white/90 hover:shadow-xl",
    ...
    return (
        <MainLayout>
            ...
            <section className="relative pt-20 pb-16 lg:pt-10 mt-14 bg-gradient-to-br from-maroon via-maroon to-red-900 overflow-hidden">
                ...
                <div className="container relative z-10 grid items-center grid-cols-1 gap-8 px-5 lg:grid-cols-2">
                    ...
                    >
                        ...
                        <div className="relative w-full lg:w-[450px]">
                            ...
                            {loading && query && (
                                <motion.div
                                    ...
                                    animate={{ opacity: 1, y: 0 }}
                                    className="absolute flex items-center w-full gap-3 p-4 mt-2 text-base text-gray-700 bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg"
                                >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 lg:flex-row">
                            ...
                            <Link href={route("dashboard.kelas")}>
                                <Button
                                    variant="outline"
                                    className="w-full sm:w-auto bg-maroon px-8 py-3 border-2 border-white text-white hover:bg-white hover:text-maroon rounded-2xl font-semibold transition-all duration-300 hover:scale-105"
                                >
                                    Daftar Gratis
                                </Button>
                            </Link>
            ...
            {/* Stats Section - Enhanced with better icons and animations */}
            ...
            {/* About Section - Enhanced layout and styling */}
            ...
            {/* Popular Classes Section - Enhanced card design */}
            <section className="py-20 bg-white">
                <div className="container">
                    <motion.div
                        initial={{ opacity: 0, y: 30 }}
                    ...
                    >
                        <div className="max-w-4xl space-y-6">
                            <h2 className="text-3xl font-bold text-white lg:text-5xl leading-tight">
                                Mulai Perjalanan Belajarmu di Dunia IT
                            </h2>
                            <p className="text-xl text-gray-200 leading-relaxed">
                                Dengan kurikulum yang dirancang sesuai kebutuhan
                                industri masa kini dan dibimbing oleh para ahli
                                berpengalaman
                            </p>
                        </div>
