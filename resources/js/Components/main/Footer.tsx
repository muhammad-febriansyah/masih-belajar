...
export default function Footer() {
    ...
    useEffect(() => {
        ...
        if (hiddenPages.some((page) => currentURL.includes(page))) {
            setIsVisible(false);
        }
            ...
            <div className="container relative z-10 px-4 py-16 mx-auto space-y-12 sm:px-6 lg:space-y-16 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    ...
                    <div className="space-y-6">
                        ...
                        {/* Trust indicators for learning platform */}
                        <div className="flex items-center gap-4 text-xs text-gray-500">
                            <div className="flex items-center gap-1">
                                <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                                <span>Platform Belajar</span>
                            </div>
                            <div className="flex items-center gap-1">
                    ...
                    <div className="col-span-1 lg:col-span-2 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                        {/* Office Contact */}
                        <div className="space-y-6">
                            <h3 className="text-lg font-bold text-maroon relative flex items-center gap-2">
                                <MapPin className="w-5 h-5" />
                                Kontak Kami
                                <div className="absolute -bottom-1 left-7 w-8 h-0.5 bg-maroon rounded-full"></div>
                            </h3>
                        ...
                        <div className="space-y-6">
                            <h3 className="text-lg font-bold text-maroon relative flex items-center gap-2">
                                ...
                                Dashboard
                                <div className="absolute -bottom-1 left-8 w-8 h-0.5 bg-maroon rounded-full"></div>
                            </h3>
                                ...
                                {[
                                    {
                                        ...
                                        label: "Kelas",
                                        icon: BookOpen,
                                        description: "Jelajahi semua kelas",
                                    },
                                    {
                                    ...
                                    },
                                    {
                                        ...
                                        label: "Belajar",
                                        icon: GraduationCap,
                                        description: "Lanjutkan pembelajaran",
                                    },
                                    {
                                        href: "/dashboard/event",
                                        label: "Event/Acara",
                                        icon: CalendarDays,
                                        description: "Temukan acara terbaru",
                                    },
                                ].map((item, i) => (
                                    <li key={i}>
                                        <Link
                                            href={item.href}
                                            className="group flex items-center gap-3 p-3 rounded-lg bg-white/30 hover:bg-white/50 transition-all duration-300 hover:shadow-sm hover:-translate-y-0.5"
                                        >
                                            <div className="p-2 bg-maroon/10 group-hover:bg-maroon rounded-lg transition-all duration-300">
                                                <item.icon className="w-4 h-4 text-maroon group-hover:text-white transition-colors duration-300" />
                                            </div>
                                            <div className="flex-1">
                                                <span className="text-sm font-semibold text-gray-700 group-hover:text-maroon transition-colors duration-300 block">
                                                    {item.label}
                                                </span>
                                            ...
                                            <ExternalLink className="w-3 h-3 text-gray-400 opacity-0 group-hover:opacity-100 transition-all duration-300" />
                                        </Link>
                                    </li>
                                ))}
                            </ul>
                        ...
                        <div className="space-y-6">
                            ...
                            <p className="text-sm text-gray-600 leading-relaxed">
                                Tetap terhubung untuk mendapatkan tips belajar
                                dan pengumuman menarik.
                            </p>
                ...
                <div className="relative">
                    ...
                    <div className="relative flex justify-center">
                        <div className="bg-white px-6 py-2 rounded-full border border-maroon/10 shadow-sm">
                            <div className="flex items-center gap-2">
                                <GraduationCap className="w-4 h-4 text-maroon animate-pulse" />
                ...
                <div className="text-center">
                    <div className="bg-white/50 backdrop-blur-sm rounded-xl p-6 border border-white/30">
                        ...
                        <div className="mt-3 flex items-center justify-center gap-6 text-xs text-gray-500">
                            ...
                            <span>•</span>
                            <span>Dibuat dengan ❤️ untuk pendidikan</span>
                            <span>•</span>
                            <span>v2.1</span>
                        </div>
                    </div>
