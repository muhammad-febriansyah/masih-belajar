...
export default function SideBar() {
    ...
    return (
        <>
            ...
            <div className="fixed  md:hidden bottom-0 left-0 right-0 flex items-center justify-between w-full h-20 px-4 bg-white z-[88] rounded-t-2xl">
                <Link
                    href="/dashboard/kelas-saya"
                    ...
                    >
                        <path
                            ...
                            className={
                                url.startsWith("/dashboard/kelas-saya")
                                    ? "fill-white"
                                    : "group-hover:fill-white fill-gray-500"
                            }
                        />
                    </svg>
                    <span
